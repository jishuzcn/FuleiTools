...
QScrollBar::sub-line:vertical {
        height: 15px;
        background: transparent;
        image: url(":/Resouces/topArrow.png");
        subcontrol-position: top;
}
QScrollBar::add-line:vertical {
        height: 15px;
        background: transparent;
        image: url(":/Resouces/bottomArrow.png");
...
QProgressBar {
        ...
        background-image: url(":/Resouces/progressBar.png");
        background-repeat: repeat-x;
}
QProgressBar::chunk {
        border: none;
        background-color: transparent;
        background-image: url(":/Resouces/progressBarChunk.png");
        background-repeat: repeat-x;
}
/**********输入框**********/
QLineEdit {
